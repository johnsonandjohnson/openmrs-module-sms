...
public class SmsScheduledTaskTest {
    ...
    public void setUp() throws Exception {
        ...
        doReturn(smsHttpService).when(Context.class, "getRegisteredComponent",
                "sms.SmsHttpService", SmsHttpService.class);
    ...
    private SmsScheduledTask prepareTask() {
        ...
        properties.put(SmsEventParams.CUSTOM_PARAMS, CUSTOM_PARAMS);
        properties.put(SmsEventParams.RECIPIENTS, RECIPIENTS);
        properties.put(SmsEventParams.DELIVERY_TIME, DELIVERY_TIME);
        properties.put(SmsEventParams.FAILURE_COUNT, FAILURE_COUNT);
