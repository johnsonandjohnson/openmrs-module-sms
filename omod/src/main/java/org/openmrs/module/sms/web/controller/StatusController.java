...
public class StatusController extends RestController {
    ...
    public void handle(@PathVariable String configName, @RequestParam Map<String, String> params,
        ...
        LOGGER.info(String.format("SMS Status - configName = %s, params = %s, bodyParam = %s",
        ...
        if (status.hasMessageIdKey() && combinedParams != null && combinedParams.containsKey(status.getMessageIdKey())) {
